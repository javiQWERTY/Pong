...
function love.load()
  ...
  --INTIALIZE player paddles and ball
...
function love.draw()
    ...
    elseif gameState == 'serve' then
        ...
        love.graphics.printf('Pres ENTER to serve!', 0, 20, VIRTUAL_WIDTH, 'center')
    elseif gameState == 'play' then
      --no UI--
    end
    
    --RENDER Paddles and BALL now using their class's RENDER METHOD
    player1:render()
    player2:render()
    ball:render()
    
    --FUNCTION just to demostrate the FPS.
    displayFPS()
